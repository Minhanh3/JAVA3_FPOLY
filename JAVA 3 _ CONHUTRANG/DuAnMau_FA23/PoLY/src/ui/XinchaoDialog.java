 ...
 * @author Manhdepzai
 */
public class XinchaoDialog extends javax.swing.JDialog {

  
    public XinchaoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   void init(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XinchaoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                XinchaoDialog dialog = new XinchaoDialog(new javax.swing.JFrame(), true);
