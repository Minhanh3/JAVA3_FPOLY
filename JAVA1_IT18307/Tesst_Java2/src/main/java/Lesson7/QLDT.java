...
public class QLDT extends javax.swing.JFrame {
    ...
    private QuanLyDienThoai qldt = new QuanLyDienThoai();
    private List<DienThoai> listview = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "256", "64", "128" }));

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Đen");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Trắng");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Vàng");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Apple", "Samsung" }));
